...
- Tokens show each player's full name in a pill above the circle (wrapping as needed) and the role label inside the token, with role-colored rings and status badges for captains, cards and absences.
