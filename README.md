...
- Tokens display the player name in a pill above the circle and the role label inside the token, with role-colored rings and status badges for captains, cards and absences.
